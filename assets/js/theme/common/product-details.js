...
export default class ProductDetails {
    constructor($scope, context, productAttributesData = {}) {
        ...
        if (this.context.addToCartMode !== 'redirect') {
    ...
    addProductToCart(event, form) {
        ...
        utils.api.cart.itemAdd(this.filterEmptyFilesFromForm(new FormData(form)), (err, response) => {
            ...
            // Feedback if inside a quickview
            if ($addToCartBtn.parents('#modal').length > 0) {
                swal({
    ...
    showCartPreview() {
        ...
        const options = {
            template: 'common/cart-preview-on-add',
        };
        ...
        utils.api.cart.getContent(options, (err, response) => {
            ...
            $cartDropdown
                ...
                .slideDown('fast');
            setTimeout(hideCartPreview, 4500);
        });
    }
