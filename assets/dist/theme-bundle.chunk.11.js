...
var Cart = function (_PageManager) {
    ...
    Cart.prototype.stickySidebar = function stickySidebar() {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_3___default()(window).on('scroll', lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(updateSticky, 100));
        jquery__WEBPACK_IMPORTED_MODULE_3___default()('.body').click(updateSticky);
    };
    ...
    Cart.prototype.bindCartEvents = function bindCartEvents() {
        ...
        var cartUpdate = lodash_bind__WEBPACK_IMPORTED_MODULE_0___default()(lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(this.cartUpdate, debounceTimeout), this);
        var cartUpdateQtyTextChange = lodash_bind__WEBPACK_IMPORTED_MODULE_0___default()(lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(this.cartUpdateQtyTextChange, debounceTimeout), this);
        var cartRemoveItem = lodash_bind__WEBPACK_IMPORTED_MODULE_0___default()(lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(this.cartRemoveItem, debounceTimeout), this);
        var preVal = void 0;
